  ...
  async confirm() {
    ...
    try {
      ...
      try {
        ...
        localStorage.setItem('lastAnalysisImage', this.imageData || '');
        console.log('💾 Result stored in localStorage as backup');
      } catch (e) {
        console.warn('⚠️ Failed to store result in localStorage:', e);
      }
